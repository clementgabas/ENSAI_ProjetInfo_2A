...
class Test_gestionAmis(unittest.TestCase):
     ...
     def test_are_pseudos_friends(self):
          ...
          self.assertFalse(DAOamis.are_pseudos_friends(pseudo1, secrets.token_hex(10)))
     ...
     def test_get_liste_amis(self):
          ...
          self.assertIsNotNone(DAOamis.get_liste_amis(pseudo1))
